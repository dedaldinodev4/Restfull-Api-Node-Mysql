        ...
        const response = {
            ...
            products: result.map(prod => {
                return {
                    ...
                    request: {
                        type: 'GET',
                        description: 'Retorna detalhe de um produto específico',
    ...
    try {
        ...
        if (result.length == 0) {
            return res.status(404).send({
                message: "Não foi encontrado produto com este ID "+req.params.productId
            });
        }
        const response = {
            product: {
...
exports.deleteProduct = async (req, res, next) => {
    try {
        ...
        const response = {
            ...
            request: {
                type: 'POST',
                description: 'Insere um produto novo',
                url: process.env.URL_API +'products',
                body: {
                    name: "String",
                    price: "Number",
